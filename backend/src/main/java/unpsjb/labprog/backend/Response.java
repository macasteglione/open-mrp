...
public class Response {
	...
	public static ResponseEntity<Object> error(Object responseObj, String message) {
		return response(HttpStatus.BAD_REQUEST, message, responseObj);
	}

	public static ResponseEntity<Object> notImplemented(String message) {
		return response(HttpStatus.NOT_IMPLEMENTED, message, null);
	}
}